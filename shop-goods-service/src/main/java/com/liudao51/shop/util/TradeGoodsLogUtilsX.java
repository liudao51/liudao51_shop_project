 ...
 */
@Slf4j
public class TradeGoodsLogUtilsX {
    ...
    public static void info(String val) {
        if (CollectionUtilsX.isArrayContainsValue(StringUtilsX.split(StringUtilsX.lowerCase(TradeGoodsLogUtilsX.getLogLevel()), ","), "info")) {
            log.info(val);
        }
    }

    public static void warn(String val) {
        if (CollectionUtilsX.isArrayContainsValue(StringUtilsX.split(StringUtilsX.lowerCase(TradeGoodsLogUtilsX.getLogLevel()), ","), "warn")) {
            log.warn(val);
        }
    }

    public static void error(String val) {
        if (CollectionUtilsX.isArrayContainsValue(StringUtilsX.split(StringUtilsX.lowerCase(TradeGoodsLogUtilsX.getLogLevel()), ","), "error")) {
            log.error(val);
        }
    }
    ...
    public static void debug(String val) {
        if (CollectionUtilsX.isArrayContainsValue(StringUtilsX.split(StringUtilsX.lowerCase(TradeGoodsLogUtilsX.getLogLevel()), ","), "debug")) {
