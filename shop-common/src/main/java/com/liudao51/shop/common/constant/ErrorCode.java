...
public enum ErrorCode {
    ...
    ORDER_SHIPPINGFEE_INVALID(22005, "订单运费不正确"),
    ORDER_AMOUNT_INVALID(22005, "订单金额不正确"),
    ORDER_REPEAT_PAY_ERROR(22006, "订单重复支付"),

    GOODS_INVALID_ERROR(23001, "商品无效"),
    GOODS_NOT_EXITS_ERROR(23002, "商品不存在"),
    GOODS_PRICE_INVALID(23003, "商品价格无效"),
    GOODS_STOCK_NOT_ENOUGH(23003, "商品库存不足"),
