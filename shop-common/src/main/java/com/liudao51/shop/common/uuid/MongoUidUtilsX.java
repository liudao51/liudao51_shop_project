...
package com.liudao51.shop.common.uuid;
 ...
 */
public final class MongoUidUtilsX implements Comparable<MongoUidUtilsX>, Serializable {
     ...
     * @return the new id
     */
    public static MongoUidUtilsX get() {
        return new MongoUidUtilsX();
    }
     ...
     * @param date the date
     */
    public MongoUidUtilsX(final Date date) {
     ...
     */
    public MongoUidUtilsX(final Date date, final int counter) {
     ...
     * @deprecated Use {@link #MongoUidUtilsX(Date, int)} instead
     */
    @Deprecated
    public MongoUidUtilsX(final Date date, final int machineIdentifier, final short processIdentifier, final int counter) {
     ...
     * @param counter           the counter
     * @throws IllegalArgumentException if the high order byte of machineIdentifier or counter is not zero
     * @deprecated Use {@link #MongoUidUtilsX(int, int)} instead
     */
    @Deprecated
    public MongoUidUtilsX(final int timestamp, final int machineIdentifier, final short processIdentifier, final int counter) {
     ...
     * @throws IllegalArgumentException if the high order byte of counter is not zero
     */
    public MongoUidUtilsX(final int timestamp, final int counter) {
        this(timestamp, counter, true);
    }

    private MongoUidUtilsX(final int timestamp, final int counter, final boolean checkCounter) {
        this(timestamp, RANDOM_VALUE1, RANDOM_VALUE2, counter, checkCounter);
    }

    private MongoUidUtilsX(final int timestamp, final int randomValue1, final short randomValue2, final int counter,
     ...
     */
    public MongoUidUtilsX(final String hexString) {
     ...
     */
    public MongoUidUtilsX(final byte[] bytes) {
     ...
     */
    MongoUidUtilsX(final int timestamp, final int machineAndProcessIdentifier, final int counter) {
     ...
     * @since 3.4
     */
    public MongoUidUtilsX(final ByteBuffer buffer) {
        if (buffer == null) {
    ...
    public boolean equals(final Object o) {
        ...
        MongoUidUtilsX objectId = (MongoUidUtilsX) o;
    ...
    @Override
    public int compareTo(final MongoUidUtilsX other) {
        if (other == null) {
     ...
     */
    @Deprecated
    public static MongoUidUtilsX createFromLegacyFormat(final int time, final int machine, final int inc) {
        return new MongoUidUtilsX(time, machine, inc);
    }
    ...
    /**
     * @return a string representation of the ObjectId in hexadecimal format
     * @see MongoUidUtilsX#toHexString()
